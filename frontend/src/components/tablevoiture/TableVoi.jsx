...
const [isImageOpen, setIsImageOpen] = useState(false);
  ...
  const base64PhotoCarteGrise = null;
    const base64PhotoAssurance =  null;
  ...
  <div className="cellWrapper">
    {user && user.cartegrise ? (
      <img
      src={`data:image/png;base64,${base64PhotoCarteGrise}`}
        alt=""
        className="image"
      ...
      <img src={`data:image/png;base64,${base64PhotoCarteGrise}`} alt="" className="image" /> // Replace placeholderImage with the source of your placeholder image
    )}
...
<TableCell className="tableCell">
  <div className="cellWrapper">
    {user && user.assurance ? (
      <img
      src={`data:image/png;base64,${base64PhotoAssurance}`}
        alt=""
        className="image"
      ...
      <img src={`data:image/png;base64,${base64PhotoAssurance}`} alt="" className="image" /> 
    )}
    ...
    {isImageOpen && clickedImage === user.assurance && (
      <div className="imageOverlay">
        ...
        <img src={`data:image/png;base64,${base64PhotoAssurance}`} alt="" className="fullImage" />
      </div>
    )}
  </div>
</TableCell>
