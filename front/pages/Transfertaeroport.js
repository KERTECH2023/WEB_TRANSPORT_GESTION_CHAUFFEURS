...
const PaymentForm = () => {
  ...
  const handleSubmitpayement = async (e) => {
    ...
    // Vérification des champs requis AVANT le paiement
    ...
    const hasEmptyField = requiredFields.some(field => !field || field.toString().trim() === "");
    ...
    try {
      ...
      toast.error("Une erreur est survenue pendant le paiement ou le transfert.");
    }
