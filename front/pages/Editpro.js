...
const Editpro = () => {
  ...
  const getSingleUser = async (id) => {
    const response = await axiosClient.get(`/Chauff/searchchauf/${id}`);
  ...
  const handleSubmit = (e) => {
    ...
    // Handle validations
    axiosClient
      .put(`/Chauff/updatechauf/${id}`, data, {
        headers: {
      ...
      <form action="" id="login" method="put" onSubmit={handleSubmit}>
        <div className="wrappere bg-white mt-sm-5">
          ...
          <div className="d-flex align-items-start py-3 border-bottom">
            <img src={form.photoAvatar || ""} className="img" alt="" />
          ...
          <div className="py-2">
            ...
            <div className="row py-2">
              ...
              <div className="col-md-6 pt-md-0 pt-3">
                ...
                />
                {phoneError && (
                  <label className="text-red-500">{phoneError}</label>
                )}
              </div>
              <div className="col-md-6 pt-md-0 pt-3">
            ...
            <div className="d-sm-flex align-items-center pt-3" id="deactivate">
              ...
              <div className="ml-auto">
                <button className="btn danger" onClick={handleSubmite}>
                  Désactiver
                </button>
              </div>
            </div>
